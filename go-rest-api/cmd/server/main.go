...
import (
	...
	"github.com/leo2904/learning-go/go-rest-api/swagger/server/restapi"
	"github.com/leo2904/learning-go/go-rest-api/swagger/server/restapi/operations"
)
...
func GetGopherByName(gopher operations.GetGopherNameParams) middleware.Responder {
	var URL string
	fmt.Println("gopher.Name:", gopher.Name)
